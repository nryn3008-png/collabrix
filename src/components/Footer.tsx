const socialLinks = [
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/in/amansoni22',
    icon: (
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/nryn3008-png',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-[var(--max-width-content)] mx-auto px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4">
            ...
            <span className="hidden md:inline text-[var(--color-text-tertiary)]">
              /
            </span>
        ...
        {/* Bottom Row */}
        <div className="mt-8 pt-6 border-t border-[var(--color-border-subtle)] text-center md:text-left">

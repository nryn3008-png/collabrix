        ...
        <div className="max-w-[var(--max-width-content)] mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-[180px_1fr] lg:grid-cols-[200px_1fr] gap-10 md:gap-14">
            ...
            <div className="">
              ...
              <a
                href="/knowmore"
                className="inline-flex items-center justify-center px-6 py-3 mt-8 text-sm font-medium text-[var(--color-text-primary)] border border-[var(--color-text-tertiary)] bg-[var(--color-bg-elevated)] rounded-lg hover:bg-[var(--color-text-primary)] hover:text-[var(--color-bg)] hover:border-[var(--color-text-primary)] transition-all duration-200"
              >
                Know more
              </a>
            </div>

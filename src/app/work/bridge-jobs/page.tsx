          ...
          <Reveal>
            <section className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="/work" className="inline-flex items-center justify-center px-6 py-3.5 text-base font-medium text-[var(--color-text-primary)] border border-[var(--color-text-tertiary)] bg-[var(--color-bg-elevated)] rounded-lg hover:bg-[var(--color-text-primary)] hover:text-[var(--color-bg)] hover:border-[var(--color-text-primary)] transition-all duration-200">Back to all work</Link>
              </div>
            </section>
          </Reveal>
